--------------------------------------------------------
-- Archivo creado  - martes-marzo-22-2022   
--------------------------------------------------------
--------------------------------------------------------
...
Insert into PROYECTO.PRODUCTOS (ID,NOMBRE,DESCRIPCION,PRECIO,REBAJA,"FECHA_AÑADIDO",CATEGORIA) values ('2','El Quijote','Autor: ','12','0',to_date('18/03/22','DD/MM/RR'),'3000');
